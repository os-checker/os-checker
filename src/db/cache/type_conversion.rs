...
impl From<CheckerTool> for os_checker_types::CheckerTool {
    fn from(value: CheckerTool) -> Self {
        match value {
            ...
            CheckerTool::AtomVChecker => Self::AtomVChecker,
            CheckerTool::Rapx => Self::Rapx,
...
impl From<os_checker_types::CheckerTool> for CheckerTool {
    fn from(value: os_checker_types::CheckerTool) -> Self {
        match value {
            ...
            os_checker_types::CheckerTool::AtomVChecker => Self::AtomVChecker,
            os_checker_types::CheckerTool::Rapx => Self::Rapx,
...
impl From<os_checker_types::Kind> for Kind {
    fn from(value: os_checker_types::Kind) -> Self {
        match value {
            ...
            os_checker_types::Kind::Audit => Self::Audit,
            ...
            os_checker_types::Kind::AtomVChecker => Self::AtomVChecker,
            os_checker_types::Kind::Rapx => Self::Rapx,
